try:
    ...
    class ExecVars:
        ...
        API_HASH = "d8dfd6ca86d5140d2a79df142b97cc95"
        API_ID = 15167599
        BOT_TOKEN = "5498560646:AAE-oSdqyscKfQHW1CNaEfj4QfJ11qO35a8"
        BASE_URL_OF_BOT = "http://172.105.167.250"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [-1001516330950]
        OWNER_ID = 1950917062
